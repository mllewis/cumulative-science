...
* Have a code specific, consistent code style makes your own code easier to understand and debug, and it helps others do the same.
--
...
`{r CHUNKNAME, fig.width = 4, fig.height = 4.5}`
---
* "Literate programming" - plain text mixed with code
